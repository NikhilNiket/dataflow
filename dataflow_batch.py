...
SCHEMA = 'Branch:STRING,Gender:STRING,Product line:STRING,Unit price:FLOAT,Quantity:INTEGER,Total:FLOAT,Date:STRING,Payment:FLOAT'	
...
def convert_types(data):
    ...
    data['Payment'] = float(data['Payment']) if 'Payment' in data else None
